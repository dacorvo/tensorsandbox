...
class Squeeze0(SqueezeNet):
    ...
    def inference(self, images):
        ...
        # fire2
        fire2 = self.fire_layer(pool1, 16, 64, 64, decay=False, name='fire2')

        # fire3
        fire3 = self.fire_layer(fire2, 16, 64, 64, decay=False, name='fire3')
        ...
        # fire4
        fire4 = self.fire_layer(fire3, 32, 128, 128, decay=False, name='fire4')
        ...
        predictions = self.avg_layer(conv2, name='conv2')
